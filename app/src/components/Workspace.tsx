...
import { GenericFormProvider } from '@/lib/generic-form-context.tsx';
      ...
      <FloatingWindowsProvider theme={isDark ? 'dark' : 'light'}>
        <div className="flex flex-col h-svh">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-sm text-foreground/70">
                    {import.meta.env.VITE_APP_SUB_NAME}
                  </span>
                  <TooltipProvider delayDuration={300}>
                    <Tooltip>
                      <TooltipTrigger className="text-sm text-foreground/70">
          ...
          <div className={'text-xs text-right pt-2 pb-1 text-slate-600'}>
            <a href={'https://flowscope.pondpilot.io/'} target={'_blank'} className={'underline'}>
              flowscope fork
            </a>
            .
          </div>
