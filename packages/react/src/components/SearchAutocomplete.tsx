  ...
  function SearchAutocomplete(
    ...
    return (
      <div
        ref={containerRef}
        className={cn(
          'relative flex items-center rounded-full border border-slate-200/60 dark:border-slate-700/60 bg-white dark:bg-slate-900 h-9 px-2 shadow-xs transition-all duration-200 min-w-[100px] w-[150px]',
          className
        )}
        data-graph-panel
